...
The update path for your Cisco collaboration devices depends on how they are registered and your chosen software provider.
...
While Cisco bundles a tested and verified set of Microsoft applications with every RoomOS release, the individual application lifecycle is managed by Microsoft.
- **Independent Updates:** Regardless of your software provider selection in Control Hub, individual Microsoft applications can be updated automatically or manually through Teams Admin Center.
- **Update Rings:** Microsoft offers three update phases: **Validation, General, and Final.** The phase selected determines how quickly an application update is applied to your devices. Your settings in Teams Admin Center will override the Microsoft application versions provided by Cisco. Read more about automatic updates from Teams Admin Center [here](https://learn.microsoft.com/en-us/microsoftteams/devices/remote-update).

### 2. Choosing a software provider (Control Hub)

#### Cisco as the software provider

With Cisco as the software provider, you can choose from the following channels:
- **Microsoft Approved:** This provides the software that has been tested and approved by Microsoft. Once Cisco receives this approval, the release is posted to this channel and deployed 24 hours later. This 24-hour window provides administrators with increased visibility and time to plan their deployment. This channel provides the same software version that is available from Microsoft.
  - See [https://learn.microsoft.com/microsoftteams/devices/android-version-support](https://learn.microsoft.com/microsoftteams/devices/android-version-support) for details on Microsoft's support policies and versions.
...
For an overview of Microsoft approved software versions, see: [latest RoomOS software version supported by Microsoft](https://learn.microsoft.com/microsoftteams/devices/certified-hardware-android?tabs=firmware).
