...
* **Camera**. Choose a camera mode, including the option to manually adjust the camera to suit your meeting. Read more about [camera settings](https://roomos.cisco.com/doc/MTR/CameraOptions).
...
*NOTE:* AirPlay sharing is only available to MTR devices with *MTRShareExperience* set to *RoomOS*.

See these articles for more information about turning on and sharing with AirPlay:
...
Read more about the [settings menu](https://roomos.cisco.com/doc/MTR/SettingsMenu).
...
3. Select and change settings as needed:
      ...
      <img src="/doc/images/MTR/Accessibility.png" style="width: 600px" />
