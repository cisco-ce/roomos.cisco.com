...
**The latest software version supported by Microsoft: RoomOS 26.4.1.4, based on RoomOS March 2026. This software version includes Teams Rooms App 1449/1.0.96.2025421910.**

**NOTE: From RoomOS 11.29.1, which introduces Android 13, it is not possible to downgrade to an earlier version of RoomOS. If you must downgrade, you need to first factory reset the device and then onboard it as a RoomOS device with the software version you want to downgrade to. Then you can onboard it the device to Microsoft Teams Rooms. This is due that Android 13 cannot downgrade between security patches. Read more about this on the [Software Upgrade](/doc/MTR/DeviceManagement#software-upgrades) page.**
