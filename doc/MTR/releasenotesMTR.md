...
**The latest software version supported by Microsoft: RoomOS 26.7.1.12, based on RoomOS June 2026. This software version includes Teams Rooms App 1449/1.0.96.2026087210.**
...
* CSCwt96895 - Codec EQ crashes when multiple Room Vision PTZ Cameras are connected.
* CSCwu30770 - Devices may become unresponsive after nightly reboot.
...
We've added three more custom channels for Microsoft approved software: Verification, Trial, and Approval Candidate. This provides more flexibility for testing and rolling out new software versions in your deployment.

These additional software channels are available in Control Hub when advanced software control is enabled.
...
NOTE: With Android 13 and onward, it is not possible to downgrade to an earlier version of RoomOS. If you must downgrade, you need to first factory reset the device and then onboard it as a RoomOS device with the software version you want to downgrade to. Then you can onboard it the device to Microsoft Teams Rooms. Read more about this on the [Software Upgrade](/doc/MTR/RoomOSUpgrades#android13_downgrade) page.
...
* [Enable from device web interface](DeviceManagement.md#the-device-web-interface)
